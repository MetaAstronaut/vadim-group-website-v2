...
- [ ] Create standard layout components:
  ...
  - `Footer`
  - `Navbar`
- [X] Footer structure aligned with `SITE_STRUCTURE.md` and content updated
- [ ] Header / Navbar updated to match Top-level Navbar in `SITE_STRUCTURE.md`

- [ ] Ensure spacing and typography follow DESIGN_SYSTEM_EN.md

## 1.2 Page Assembly (using `.md` content files)

- [X] Home Page — assembled from `home.md`, aligned with new content model
- [ ] Repairs Page
- [ ] Marine & RV Page
- [ ] Commercial Page
- [ ] About Page
