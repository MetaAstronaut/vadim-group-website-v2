...
const Footer = () => {
  ...
  return <footer className="bg-primary pt-24 pb-12 relative overflow-hidden">
      {/* Decorative Elements */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
          ...
          <div>
            ...
            <nav className="space-y-4">
              {quickLinks.map(link => <Link key={link.name} to={link.href} className="block text-white/60 hover:text-secondary-light transition-colors text-base group">
