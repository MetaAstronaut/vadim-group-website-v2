        ...
        <div className="flex flex-col">
          ...
          <Section className="bg-brand-primary text-white py-24 md:py-32 text-center relative overflow-hidden">
            <Container className="relative z-10">
              ...
              {/* PRIMARY CTA: Gold WhatsApp button with icon */}
              <div className="flex flex-col items-center gap-4">
                ...
                >
                  <a 
                    href="https://wa.me/your-number?text=Hi%2C%20I%27d%20like%20to%20get%20a%20free%20estimate%20for%20my%20repair%20project."
                    target="_blank" 
