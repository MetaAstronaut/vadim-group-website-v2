...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/components/archive/ui/accordion";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/archive/ui/tabs";
import {
  Dialog,
  DialogContent,
  DialogDescription,
  DialogHeader,
  DialogTitle,
} from "@/components/archive/ui/dialog";
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl">
              At The Vadim Group, we understand that your home is more than just
              a building – it's where life happens. From small fixes to major
              repairs, our skilled professionals deliver quality craftsmanship
              and reliable solutions that keep your home safe, comfortable, and
              beautiful.
            </p>
          </div>
        </div>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-5xl mx-auto">
            <Accordion type="single" collapsible className="space-y-6">
              <AccordionItem
                value="interior"
                className="border-2 border-card-border bg-card rounded-2xl p-8 transition-all duration-500 hover:shadow-premium-lg hover:border-secondary/40"
              >
                    ...
                    {interiorServices.map((service, index) => (
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          <span className="font-semibold text-foreground text-[17px] block">
                            {service.name}
                          </span>
                          <span className="text-muted-foreground leading-[1.7] block">
                            {service.desc}
                          </span>
                        </div>
                      </li>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="max-w-4xl mx-auto mb-20 text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Regular maintenance can prevent costly repairs and extend the
                life of your home's systems and structures
              </p>
            </div>
              ...
              <TabsContent value="monthly">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Essential checks to perform every month
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="quarterly">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Important maintenance every 3 months
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3">
              ...
              <TabsContent value="annual">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Comprehensive yearly maintenance checklist
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3">
              ...
              <TabsContent value="biannual">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Long-term maintenance for optimal home care
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="max-w-4xl mx-auto mb-20 text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Our streamlined process ensures your repair project is handled
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="relative group hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We listen carefully to understand your needs, inspect the
                    issue thoroughly, and provide honest recommendations.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="relative group hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    You'll receive a clear, itemized estimate with no hidden
                    fees. We explain every line item so you understand exactly
              ...
              <Card className="relative group hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We work around your schedule. Whether you need evening or
                    weekend service, we accommodate your availability.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="relative group hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Our skilled professionals complete your repair using quality
                    materials and proven techniques. We keep you updated
              ...
              <Card className="relative group hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We inspect every detail to ensure the repair meets our high
                    standards. Your satisfaction is our priority.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="relative group hover:shadow-premium-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We stand behind our work. After completion, we check in to
                    ensure everything is perfect and answer any questions.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="section-padding bg-gradient-to-b from-background via-muted/50 to-background relative overflow-hidden border-t border-border/40">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-lg md:text-xl mb-10 text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Request your free estimate today and discover why homeowners trust
            The Vadim Group
          </p>
          <Button
            size="lg"
